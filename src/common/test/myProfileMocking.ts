...
export const createNewAddressEdgeWithNodeData = (
  ...
  createNewEdgeWithData(createAddressEdge(), newValues) as AddressEdge;
...
export const createNewEmailEdgeWithNodeData = (
  ...
  createNewEdgeWithData(createEmailsEdge(), newValues) as EmailEdge;
...
export const createNewPhoneEdgeWithNodeData = (
  ...
  createNewEdgeWithData(createPhonesEdge(), newValues) as PhoneEdge;
