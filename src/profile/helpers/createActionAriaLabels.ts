...
export default function createActionAriaLabels(dataType: EditDataType, value: string, t: TFunction): ActionAriaLabels {
  if (dataType === 'phones' || dataType === 'emails' || dataType === 'addresses') {
