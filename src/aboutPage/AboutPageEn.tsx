...
function AboutPageEn(): ReactElement {
  return (
    <Fragment>
      ...
      <p>
        You may use the Helsinki profile and its authentication to various
        digital applications
      </p>
      <ul>
        <li>strongly via Suomi.fi authentication</li>
        <li>
          lightly by using the Helsinki ID email address and password
          combination
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        as delete their data from one or all services. By deleting their entire
        profile, users will also delete all of their data from all of the
        services. Deleting data from individual services can be done in the
        profile’s settings.
      </p>
